...
def image_input(node_id: str, name: str, x: int, y: int, image: dict, video: bool = False) -> dict:
	...
	return {
		...
		"params": {"fileName": name + ".embedded.mp4", "dataUrl": image["dataUrl"], params_key: image, "baseFrameMessage": image, "embeddedVideo": True, "embeddedFps": 30, "publishHz": 30, "useSourceFps": False, "duration": 10, "loop": True, "outputMaxSide": 160} if video else {"fileName": name + ".embedded.png", "dataUrl": image["dataUrl"], params_key: image, "publishMode": "oneshot", "publishHz": 1},
		"loopCode": "",
